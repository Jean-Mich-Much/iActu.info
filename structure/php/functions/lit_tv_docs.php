<?php function parse_complet($fichier, $logo, $lienSite, $w, $h, $titreSite)
{
 ...
 foreach ($xml->channel as $channel) {
  ...
  foreach ($programmes as $programme) {
   if ((string) $programme['channel'] != (string) $channel['id'])
    continue;
   if ((string) $programme->category != 'Documentaire')
    continue;
 ...
 echo '<div class="boite"><div class="progtvcomplet"><div class="progtv"><div class="menutv"><a href="tv.php" class="inactif"><div class="titremenutv">⏰ Programme</div></a> | <a href="tv_00.php" class="inactif"><div class="titremenutv">🕛 Nuit</div></a> | <a href="tv_06.php" class="inactif"><div class="titremenutv">🕕 Matin</div></a> | <a href="tv_12.php" class="inactif"><div class="titremenutv">🕛 Après-midi</div></a> | <a href="tv_18.php" class="inactif"><div class="titremenutv">🕕 Soir</div></a> | <a href="tv_demain.php" class="inactif"><div class="titremenutv">📅 Demain</div></a> | <a href="tv_films.php" class="inactif"><div class="titremenutv">🍿 Films</div></a> | <a href="tv_series.php" class="inactif"><div class="titremenutv">🎬 Séries</div></a> | <a href="tv_docs.php" class="actif"><div class="titremenutv">🎥 Documentaires</div></a> | <a href="tv_jeunesse.php" class="inactif"><div class="titremenutv">🌈 Jeunesse</div></a></div>' . $output . '</div></div></div>';
}
