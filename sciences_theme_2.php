...
<html lang="fr">
 ...
 <body id="body" lang="fr">
  ...
  <div class="container">
   ...
   <main class="mid">
    <?php parse('futur', 'Fut', 'https://www.futura-sciences.com/', 151, 144, 'Futura',29,'https://iactu.info/recherche/p/i/?a=rss&get=f_36&user=Gon1Kirua&token=flux&hours=2400'); ?>

    <?php parse('tecsci', 'Tec', 'https://www.techno-science.net/', 144, 144, 'Techno-Science',34,'https://iactu.info/recherche/p/i/?a=rss&get=f_39&user=Gon1Kirua&token=flux&hours=2400'); ?>

<?php parse('sciav', 'ScA', 'https://www.sciencesetavenir.fr/', 144, 144, 'Sciences et Avenir',39,'https://iactu.info/recherche/p/i/?a=rss&get=f_38&user=Gon1Kirua&token=flux&hours=2400'); ?>

<?php parse('scipo', 'ScP', 'https://sciencepost.fr/', 144, 144, 'SciencePost',44,'https://iactu.info/recherche/p/i/?a=rss&get=f_37&user=Gon1Kirua&token=flux&hours=2400'); ?>

    <?php parse('get8', 'TFr', 'https://iactu.info/recherche/p/i/?a=normal&get=c_8', 227, 144, 'Autres sites',49,'https://iactu.info/recherche/p/i/?a=rss&get=c_8&user=Gon1Kirua&token=flux&hours=2400'); ?>

    <?php parse('get9', 'TUK', 'https://iactu.info/recherche/p/i/?a=normal&get=c_9', 221, 144, 'English',54,'https://iactu.info/recherche/p/i/?a=rss&get=c_9&user=Gon1Kirua&token=flux&hours=2400'); ?>
   </main>
