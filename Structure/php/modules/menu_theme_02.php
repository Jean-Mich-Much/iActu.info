...
<a class="logo" href="<?php echo $lien_accueil_theme_02; ?>" title="Accueil"><span class="f18px m5px">🔖</span>iACTU<span class="logobarre m5px">&#124;</span><span class="logoinfo">INFO</span><span class="f28px flip45 m10px">🚀</span></a>
</span>

<span class="pad8px m3px">
<a class="menulien p3px <?php if ($page_active == 'technologie') {echo 'page_active'; } ?>" href="<?php echo $lien_tech_theme_02; ?>" title="Technologie"><span class="menu_ico m3px">🤖</span><?php if ($page_active == 'technologie') {echo 'Tech.'; } ?></a>
</span>

<span class="pad8px m3px">
<a class="menulien p3px <?php if ($page_active == 'apple') {echo 'page_active'; } ?>" href="<?php echo $lien_apple_theme_02; ?>" title="Apple"><span class="menu_ico m3px">🍏</span><?php if ($page_active == 'apple') {echo 'Apple'; } ?></a>
</span>

<span class="pad8px m3px">
<a class="menulien p3px <?php if ($page_active == 'jeux') {echo 'page_active'; } ?>" href="<?php echo $lien_jeux_theme_02; ?>" title="Jeux"><span class="menu_ico m3px">🕹️</span><?php if ($page_active == 'jeux') {echo 'Jeux'; } ?></a>
</span>

<span class="pad8px m3px">
<a class="menulien p3px <?php if ($page_active == 'sciences') {echo 'page_active'; } ?>" href="<?php echo $lien_sciences_theme_02; ?>" title="Sciences"><span class="menu_ico m3px">🧪</span><?php if ($page_active == 'sciences') {echo 'Sciences'; } ?></a>
</span>
