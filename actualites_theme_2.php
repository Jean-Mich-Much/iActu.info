 ...
 <body id="body" lang="fr">
  ...
  <div class="container">
   ...
   <main class="mid">
    ...
    <?php parse('actu4', 'TFr', 'https://iactu.info/recherche/p/i/?a=normal&get=c_4', 227, 144, 'France',27,'https://iactu.info/recherche/p/i/?a=rss&get=c_4&user=Gon1Kirua&token=flux&hours=2400'); ?>

    <?php parse('actu6', 'Imo', 'https://iactu.info/recherche/p/i/?a=normal&get=c_6', 114, 144, 'Monde',32,'https://iactu.info/recherche/p/i/?a=rss&get=f_134&user=Gon1Kirua&token=flux&hours=2400'); ?>

    <?php parse('actu5', 'Iin', 'https://iactu.info/recherche/p/i/?a=normal&get=c_5', 194, 144, 'Insolites',37,'https://iactu.info/recherche/p/i/?a=rss&get=c_5&user=Gon1Kirua&token=flux&hours=2400'); ?>

    <?php parse('actu2', 'TvC', 'https://iactu.info/recherche/p/i/?a=normal&get=c_2', 154, 144, 'TV - Cinéma',42,'https://iactu.info/recherche/p/i/?a=rss&get=c_2&user=Gon1Kirua&token=flux&hours=2400'); ?>

    <?php parse('actu10', 'Spo', 'https://iactu.info/recherche/p/i/?a=normal&get=c_10', 178, 144, 'Sports',47,'https://iactu.info/recherche/p/i/?a=rss&get=c_10&user=Gon1Kirua&token=flux&hours=2400'); ?>

    <?php parse('actu3', 'TUK', 'https://iactu.info/recherche/p/i/?a=normal&get=c_3', 221, 144, 'English',52,'https://iactu.info/recherche/p/i/?a=rss&get=c_3&user=Gon1Kirua&token=flux&hours=2400'); ?>
   </main>
