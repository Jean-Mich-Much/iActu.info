...
<html lang="fr">
 ...
 <body id="body" lang="fr">
  ...
  <div class="container">
   ...
   <main class="mid">
    <?php parse('macge', 'Mac', 'https://www.macg.co/', 144, 144, 'MacG',25,'https://iactu.info/recherche/p/i/?a=rss&get=f_75&user=Gon1Kirua&token=flux&hours=2400'); ?>

    <?php parse('macbi', 'Mbi', 'http://macbidouille.com/', 240, 144, 'MacBidouille',30,'https://iactu.info/recherche/p/i/?a=rss&get=f_74&user=Gon1Kirua&token=flux&hours=2400'); ?>

    <?php parse('conso', 'Csm', 'https://consomac.fr/', 144, 144, 'Consomac',35,'https://iactu.info/recherche/p/i/?a=rss&get=f_72&user=Gon1Kirua&token=flux&hours=2400'); ?>

    <?php parse('mc4ve', 'M4e', 'https://www.mac4ever.com/', 91, 144, 'Mac4Ever',40,'https://iactu.info/recherche/p/i/?a=rss&get=f_73&user=Gon1Kirua&token=flux&hours=2400'); ?>

    <?php parse('get16', 'TFr', 'https://iactu.info/recherche/p/i/?a=normal&get=c_16', 227, 144, 'Autres sites',45,'https://iactu.info/recherche/p/i/?a=rss&get=c_16&user=Gon1Kirua&token=flux&hours=2400'); ?>

    <?php parse('get21', 'TUK', 'https://iactu.info/recherche/p/i/?a=normal&get=c_17', 221, 144, 'English',50,'https://iactu.info/recherche/p/i/?a=rss&get=c_17&user=Gon1Kirua&token=flux&hours=2400'); ?>
   </main>
