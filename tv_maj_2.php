...
<?php if (!file_exists('tv_maj_2.html') or filemtime('tv_maj_2.html') < (time() - 15)) { ?>
...
<div class="tv-grid">
 <?php lit_tv('xmltv_tnt', '20:46:59', '23:59:59', '25', '2', '152', '52', false, true, true, true, '00:00:00', '07:59:59',false,'2'); ?>
</div>
<!-- FIN -->
<!-- DEBUT -->
...
<?php lit_tv('xmltv_tnt', '23:59:59', '23:59:59', '25', '2', '152', '52', false, true, true, true, '20:46:59', '23:59:59',true,'2'); ?>
</div>
<!-- FIN -->
...
if (
 ...
 strlen($tv_maj) >= 1024
) {@file_put_contents('tv_maj_2.html', $tv_maj);copy('tv_maj_2.html','tv_maj_final_2.html');}}