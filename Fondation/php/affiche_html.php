...
foreach($t as $i)echo'<li class="news-item"><a class="n" rel="noopener" target="_blank" id="'.news_id().'" href="'.$i->link.'">'.$i->title.'</a></li>';
echo'</ul></section>';
...
foreach($o as $i)echo'<li class="news-item"><a class="n" rel="noopener" target="_blank" id="'.news_id().'" href="'.$i->link.'">'.$i->title.'</a></li>';
echo'</ul></section>';
}
