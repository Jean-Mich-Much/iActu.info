...
<html lang="fr">
 ...
 <head>
  ...
  <?php @include 'structure/php/sombre_head.php'; ?>
 </head>

 <body id="body" lang="fr">

  <nav id="haut">
   <?php @include 'structure/php/sombre_navhaut.php'; ?>
  </nav>
  ...
  <nav id="bas">
   <?php @include 'structure/php/sombre_navbas.php'; ?>
  </nav>
